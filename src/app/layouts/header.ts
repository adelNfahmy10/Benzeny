...
export class HeaderComponent {
    ...
    branches:any[] | null = JSON.parse(localStorage.getItem('allBranches') || 'null');
    branchId:string | null = localStorage.getItem('branchId') || 'null';
    ...
    changeBranch(): void {
        ...
        this.branchId = this.selectedBranchId ?? null;
        window.location.reload();
    }
